...
<ul>
    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
        &quot;Our&quot; in this Disclaimer) refers to Guitarist Chord.</li>
    <li><strong>Service</strong> refers to the Website.</li>
    <li><strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf
        of which such individual is accessing or using the Service, as applicable.</li>
    <li><strong>Website</strong> refers to Guitarist Chord, accessible from <a href="https://guitaristchord.com/"
            rel="external nofollow noopener" target="_blank">https://guitaristchord.com/</a></li>
</ul>
<h1>Disclaimer</h1>
...
<p>The Company does warrant that the Service is free of viruses.</p>

<h1>External Links Disclaimer</h1>
<p>The Service contain links to external websites that are securely provided or maintained by or in any way affiliated
    with the Company.</p>
...
<p>The information given by the Service is for general guidance on matters of interest only. Even if the Company takes
    every precaution to insure that the content of the Service is both current and accurate, errors can occur. Plus,
...
<p>Comments published by users are their sole responsibility and the users will take full responsibility, liability and
    blame for any libel or litigation that results from something written in or as a direct result of something written
    in a comment. The Company is not liable for any comment published by users and reserves the right to delete any
...
<ul>
    <li>By visiting this page on our website: <a href="https://guitaristchord.com/contact-us"
            rel="external nofollow noopener" target="_blank">https://guitaristchord.com/contact-us</a></li>
</ul>
