...
@section('content')
    <div class="row">
        ...
        <div class="d-none d-sm-block col-md-6 embed-responsive embed-responsive-16by9">
            <iframe width="560" height="315" class="embed-responsive-item" src="{{ $song->meta['canonical_link'] }}"
