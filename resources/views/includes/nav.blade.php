<header class="p-3 mb-3 bg-primary">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            {{-- Search Form --}}
            <form class="d-flex col-12 col-lg-8 mb-3 mb-lg-0 mx-auto" method="get" action="{{ route('search') }}">
                <input class="form-control" type="search" name="q" placeholder="Search Artists,Songs" id="search"
